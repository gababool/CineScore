...
public class MovieAPIService {
    ...
    public static Movie retrieveMovieFromTitleAndYear(String movieTitle, String movieReleaseYear){
        Movie movie = null;
        try{
    ...
    public static Movie retrieveMovieFromTitleOnly(String movieTitle){
        Movie movie = null;
        try{
            String encodedTitle = URLEncoder.encode(movieTitle, "UTF-8");

            String fullUrl = baseUrl + "?t=" + encodedTitle + "&apikey=" + apiKey;
